  ...
  const {til} = useContext(LangContext);
   ...
   return (
      <div className="lg:w-[1450px] px-[20px] m-auto rounded-[50px] pt-[180px]">
         <div className="relative flex flex-col md:flex-row items-center justify-between md:p-[70px] p-[30px] pt-[200px] bg-[#236F48] rounded-[40px]">
            <img className="absolute top-[-90px] lg:top-[-120px] left-0 lg:left-[220px] md:w-[870px] right-[380px]" src={articleImg} alt="" />
