         ...
         <div className="lg:w-[1490px] px-[20px] m-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
               ...
               <div ref={langRef} className="relative">
                  ...
                  >
                     <p className="text-white cursor-pointer">{til.toUpperCase()}</p>
                     <button>
                  ...
                  <div className={`bg-[#A17F4A] rounded-lg ${langClick ? "fixed lg:top-[60px] top-[60px] lg:right-[33px] right-[59px] z-40" : "hidden"}`}>
                     <ul className="flex flex-col items-start gap-2">
                        <li onClick={() => handleLangChange("uz")} className="flex items-center gap-2 text-white hover:bg-slate-600 px-[10px] py-[5px] cursor-pointer rounded-t-lg">
                           <img className="w-[16px] h-[16px]" src={UzbImg} alt="UZB" />
                           <p>UZ</p>
                        </li>
                        <li onClick={() => handleLangChange("ru")} className="flex items-center gap-2 text-white hover:bg-slate-600 px-[10px] py-[5px] cursor-pointer">
                           <img className="w-[16px] h-[16px]" src={RussiaImg} alt="RU" />
                           <p>RU</p>
                        </li>
                        <li onClick={() => handleLangChange("en")} className="flex items-center gap-2 text-white hover:bg-slate-600 px-[10px] py-[5px] cursor-pointer rounded-b-lg">
               ...
               <div className={`fixed top-0 right-0 h-screen w-full bg-white z-40 transform transition-transform duration-300 ease-in-out ${menuActive ? "translate-x-0" : "translate-x-full"}`}>
                  <div
                  ...
                  <nav className="mt-[60px]">
                     <ul className="flex flex-col items-center gap-[25px] px-[20px] pt-[10px] pb-[20px]">
                        <li className="text-[20px] text-[#00000098] hover:text-slate-600 transition-all" onClick={() => setMenuActive(false)}>
